  ...
  for (let i = 1; i < rows.length; i++) {
    ...
    try {
      ...
      records.push({
        ...
        outputCost: raw.outputCost,
        toolCalls: raw.toolCalls,
        toolCost: raw.toolCost,
        successes: raw.successes,
        failures: raw.failures,
        latencyP50Ms: raw.latencyP50Ms,
        latencyP95Ms: raw.latencyP95Ms,
        stablePrefixHash: raw.stablePrefixHash,
        stablePrefixTokens: raw.stablePrefixTokens,
        cacheEligibleInputTokens: raw.cacheEligibleInputTokens,
        sourceLine: line,
        fingerprint,
        isDemo,
      });
