    ...
    <section className="mx-auto w-full max-w-5xl overflow-hidden rounded-[32px] border border-slate-200 bg-[#080c12] text-white shadow-[0_36px_120px_rgba(15,23,42,.16)]">
      ...
      <div className="relative min-h-[560px] overflow-hidden p-6 sm:p-8 lg:p-10">
        <div
          ...
          style={{
            background:
              'radial-gradient(circle at 80% 20%, rgba(81,120,255,.11), transparent 29%), radial-gradient(circle at 18% 86%, rgba(110,231,183,.09), transparent 26%)',
          }}
        />
          ...
          {step === 'choice' ? (
            ...
            >
              <p className="m-0 text-[10px] font-semibold uppercase tracking-[0.16em] text-emerald-200/65">
                Step 1 · choose the easiest path
              </p>
              ...
              <p className="mt-5 max-w-2xl text-sm leading-6 text-white/48">
                Pick one. We keep the rest of the workflow out of your way until
              ...
              <div className="mt-9 grid gap-4 md:grid-cols-2">
                ...
                >
                  ...
                  <h2 className="m-0 mt-8 text-2xl font-semibold tracking-[-0.035em] text-white">
                    Connect a source
                  </h2>
                  <p className="m-0 mt-2 max-w-sm text-sm leading-6 text-white/43">
                    Use a supported provider connection. We fetch the evidence
                ...
                >
                  <span className="grid size-12 place-items-center rounded-2xl border border-blue-300/15 bg-blue-300/[0.055]">
                    <FileSpreadsheet className="size-5 text-blue-200" />
                  </span>
                  <h2 className="m-0 mt-8 text-2xl font-semibold tracking-[-0.035em] text-white">
                    Upload CSV
                  </h2>
                  <p className="m-0 mt-2 max-w-sm text-sm leading-6 text-white/43">
                    Already have an export? Upload it, validate it, then run the
                    exact same analysis engine.
                  </p>
            ...
            >
              ...
              <p className="m-0 mt-8 text-[10px] font-semibold uppercase tracking-[0.16em] text-emerald-200/65">
                Connect · provider
              </p>
              <h1 className="mt-3 text-[clamp(2.6rem,5vw,4.8rem)] font-semibold leading-[.94] tracking-[-.06em] text-white">
                Choose the source.
              </h1>
              ...
              <div className="mt-8 grid gap-4 md:grid-cols-3">
                {[
                  ...
                  <motion.div
                    ...
                    className="relative overflow-hidden rounded-[24px] border border-white/[0.08] bg-white/[0.025] p-5"
                  >
            ...
            >
              ...
              <p className="m-0 mt-8 text-[10px] font-semibold uppercase tracking-[0.16em] text-blue-200/65">
                Upload · CSV
              </p>
              <h1 className="mt-3 max-w-[14ch] text-[clamp(2.6rem,5vw,4.8rem)] font-semibold leading-[.94] tracking-[-.06em] text-white">
                Bring your usage export.
              </h1>
              <p className="mt-4 max-w-2xl text-sm leading-6 text-white/45">
                Your secure workspace will validate the file before any row
                becomes evidence.
              </p>
                ...
                <div className="grid min-h-56 place-items-center text-center">
                  <div>
                    <motion.span
                      ...
                      className="mx-auto grid size-14 place-items-center rounded-[20px] border border-blue-300/18 bg-blue-300/[0.06]"
                    >
                      <UploadCloud className="size-6 text-blue-200" />
                    </motion.span>
                    <h2 className="m-0 mt-5 text-xl font-semibold text-white">
                      Drag. Validate. Analyze.
                    </h2>
                    <p className="m-0 mt-2 text-sm text-white/36">
                      CSV up to 10 MiB · no provider key needed
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <p className="m-0 text-[11px] text-white/30">
                  {organizationId === null
                    ? 'Sign in only now, because you chose a private-data path.'
                    : 'Your workspace is ready for the file.'}
                </p>
                <Link
                  href={realHref('csv')}
                  className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl bg-white px-5 py-3 text-sm font-semibold text-slate-950 no-underline"
                >
                  {organizationId === null
