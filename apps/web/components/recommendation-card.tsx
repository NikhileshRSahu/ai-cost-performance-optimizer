    ...
    <article className="overflow-hidden rounded-[22px] border border-white/[0.08] bg-[#0a0f16] shadow-[0_24px_70px_rgba(0,0,0,.18)]">
      <div className="grid gap-6 p-5 sm:p-6 lg:grid-cols-[1.25fr_.75fr]">
        <div>
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            <span className="rounded-full border border-white/[0.09] bg-white/[0.035] px-2.5 py-1 text-[10px] font-semibold text-white/72">
        ...
        <div className="grid gap-2.5">
          <div className="rounded-xl border border-white/[0.07] bg-white/[0.025] p-3">
            <div className="flex items-center gap-2 text-[10px] font-semibold uppercase tracking-[0.12em] text-white/68">
          ...
          <div className="rounded-xl border border-white/[0.07] bg-white/[0.025] p-3">
            ...
            <p className="m-0 mt-2 text-xs leading-5 text-white/72">
      ...
      <div className="border-t border-white/[0.07] bg-white/[0.018] px-5 py-4 sm:px-6">
        ...
        <div className="mt-4 flex flex-wrap gap-2.5">
          ...
          recommendation.decision === 'OPTIMIZE' ? (
            <Link
              className="inline-flex min-h-10 items-center rounded-xl border border-white/10 bg-white/[0.035] px-4 py-2 text-xs font-semibold text-white/78 no-underline transition hover:bg-white/[0.07]"
              href={`/o/${organizationId}/lab/${recommendation.recommendationId}`}
            >
              Inspect evidence
            </Link>
