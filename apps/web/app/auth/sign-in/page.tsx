    ...
    <section className="auth-shell auth-centered">
      <div className="auth-card auth-product-card">
        <div className="auth-card-heading">
          ...
          <h1>Sign in to Evalomics</h1>
          <p>Continue to your AI cost and performance workspace.</p>
        </div>
        ...
        {!googleOAuthReady && <p className="form-error">Google sign-in is awaiting the production client secret.</p>}
