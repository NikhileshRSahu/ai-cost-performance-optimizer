  ...
  return <main className="auth-page auth-clean">
    ...
    <section className="auth-shell auth-centered">
      <div className="auth-card auth-product-card">
        <div className="auth-card-heading"><p className="eyebrow">WELCOME BACK</p><h1>Sign in to Evalomics</h1><p>Continue to your AI cost and performance workspace.</p></div>
        ...
        <form action={action}>
          ...
          <button className="btn black full auth-submit" disabled={pending}>{pending ? 'Signing in…' : 'Sign in with email'}</button>
        </form>
