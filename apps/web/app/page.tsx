  ...
  return (
    <div className="landing-stack">
      <section className="hero hero-wide" aria-labelledby="page-title">
        ...
        <p className="lede">
          Work MRI turns usage evidence into an explainable efficiency diagnosis,
          proposes bounded optimizations, tests them against a quality floor, and
          keeps potential, tested, and verified savings separate.
        </p>
        ...
        <div className="hero-actions" aria-label="Product trust signals">
          ...
          <span className="trust-chip">No prompt content required for usage MRI</span>
      ...
      <section className="landing-grid" aria-labelledby="proof-title">
        <div>
          ...
          <h2 id="proof-title">A public beta you can inspect, not a user count you have to trust.</h2>
          <p className="lede">
        ...
        <div className="metrics-grid" aria-label="Public beta evidence">
          ...
          <article className="metric-card">
            ...
            <span className="metric-detail">
              BurstGPT real-world Azure-backed traces are used for workload-pattern
              validation, not customer-result claims.
            </span>
          </article>
          <article className="metric-card">
      ...
      <section className="landing-grid" aria-labelledby="how-title">
        ...
        <ol className="landing-steps">
          <li>
            ...
            <span>
              Start with usage evidence you already own. Deeper access is optional
      ...
      <section className="privacy-ladder" aria-labelledby="privacy-title">
        <div>
          ...
          <p className="lede">
            Each evidence level unlocks more analysis. The Work MRI must withhold
            any conclusion that the current evidence cannot support.
          </p>
        </div>
        <div className="privacy-levels">
          <article>
            ...
            <p>Cost, model, retry, token, cache, latency, and outcome economics.</p>
          </article>
          <article>
            <span>02</span>
      ...
      <section className="evidence-note">
        <strong>Public-beta rule:</strong> research evidence is research evidence,
        demo evidence is demo evidence, and customer evidence is customer evidence.
        None are silently relabeled to make the product look more popular or more
