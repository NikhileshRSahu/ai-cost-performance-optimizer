      ...
      <section className="rounded-xl border border-white/[0.07] bg-white/[0.02] p-5">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="m-0 mt-1 text-[11px] text-white/32">
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              ...
              className="inline-flex min-h-10 items-center gap-2 rounded-lg border border-white/[0.08] bg-white/[0.025] px-3.5 py-2 text-xs font-semibold text-white/70 no-underline transition hover:text-white"
            >
